...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PackageIndex.updated_from_remote_at'
        db.add_column('packageindex_packageindex', 'updated_from_remote_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PackageIndex.updated_from_remote_at'
        db.delete_column('packageindex_packageindex', 'updated_from_remote_at')
