...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Release.is_from_external'
        db.add_column('packageindex_release', 'is_from_external', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Package.updated_from_remote_at'
        db.add_column('packageindex_package', 'updated_from_remote_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PackageIndex.simple_url'
        db.add_column('packageindex_packageindex', 'simple_url', self.gf('django.db.models.fields.URLField')(default='http://pypi.python.org/simple', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Release.is_from_external'
        db.delete_column('packageindex_release', 'is_from_external')

        # Deleting field 'Package.updated_from_remote_at'
        db.delete_column('packageindex_package', 'updated_from_remote_at')

        # Deleting field 'PackageIndex.simple_url'
        db.delete_column('packageindex_packageindex', 'simple_url')
